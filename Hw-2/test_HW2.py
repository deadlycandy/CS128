...
class TestHW2(unittest.TestCase):
    ...
    def spin_up_nodes(self):
        ...
        print("process1" + exec_string_main)
        ...
        print("process2" + exec_string_forw1)
        ...
        print("process3" + exec_string_forw2)
    ...
    def test_f_search_nonexistent_key(self):
        ...
        self.assertEqual(res.status_code, 404)
        self.assertEqual(d['result'], 'Error')
        self.assertEqual(d['isExists'], False)
    ...
    def test_g_search_existing_key(self):
        ...
        #print(res.json())
        self.assertEqual(d['result'], 'Success')
        self.assertEqual(d['isExists'], True)
    ...
    def test_h_del_nonexistent_key(self):
        ...
        self.assertEqual(res.status_code, 404)
        self.assertEqual(d['result'], 'Error')
        self.assertEqual(d['msg'], 'Status code 404')
